...
void compileForSt(void) {
  ...
  Type *t1 = obj->varAttrs->type;
  eat(SB_ASSIGN);
  Type *t2 = compileExpression();
  checkTypeEquality(t1, t2);
  eat(KW_TO);
  Type *express2 = compileExpression();
  checkTypeEquality(t1, express2);
  eat(KW_DO);
  compileStatement();
}
...
int compile(char *fileName) {
  ...
  // printObject("Chuong trinh daxdich thanh cong",0);
  // printf("\nChuong trinh da bien dich thanh cong\n");
